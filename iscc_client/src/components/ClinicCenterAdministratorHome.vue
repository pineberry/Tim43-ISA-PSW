<template>
  <div class="container">
      <ul class="nav nav-tabs swatch-cyan">
            <li class="nav-item">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="http://localhost:8081/clinicCenterAdministratorHome" role="button" aria-haspopup="true" aria-expanded="false">{{user}}</a>
